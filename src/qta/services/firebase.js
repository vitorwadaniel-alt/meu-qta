...
// CONFIGURAÇÃO FIREBASE – usa variáveis de ambiente ou valores padrão (projeto meu-qta-demo)
const firebaseConfig = {
  apiKey: import.meta.env.VITE_FIREBASE_API_KEY ?? "AIzaSyAud05lMQ2EcsN9rfBnNOqITEty-qxaVXc",
  authDomain: import.meta.env.VITE_FIREBASE_AUTH_DOMAIN ?? "meu-qta-demo.firebaseapp.com",
  projectId: import.meta.env.VITE_FIREBASE_PROJECT_ID ?? "meu-qta-demo",
  storageBucket: import.meta.env.VITE_FIREBASE_STORAGE_BUCKET ?? "meu-qta-demo.firebasestorage.app",
  messagingSenderId: import.meta.env.VITE_FIREBASE_MESSAGING_SENDER_ID ?? "578574486275",
  appId: import.meta.env.VITE_FIREBASE_APP_ID ?? "1:578574486275:web:4f365c1d2e663f33057736",
  measurementId: import.meta.env.VITE_FIREBASE_MEASUREMENT_ID ?? "G-11NDP1WWYQ",
};
...
if (useEmulators) {
  try {
    ...
    console.log("✅ Conectado aos emuladores do Firebase (Auth: 9199, Firestore: 8180, Functions: 5101)");
  } catch (error) {
